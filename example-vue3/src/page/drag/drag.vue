<template>
  <el-container>
    <el-aside width="200px">
      <div draggable="true" class="node-container" @dragstart="(e)=>{dragstart(e,user1)}" ref="user1">
        <dragNode :itemData="user1"/>
      </div>
      <div draggable="true" class="node-container" @dragstart="(e)=>{dragstart(e,user2)}" ref="user2">
        <dragNode :itemData="user2"/>
      </div>
      <div draggable="true" class="node-container" @dragstart="(e)=>{dragstart(e,user3)}" ref="user3">
